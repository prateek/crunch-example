...
public class employee_record extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"employee_record\",\"namespace\":\"com.cloudera.sa.examples\",\"fields\":[{\"name\":\"id\",\"type\":\"string\"},{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"age\",\"type\":\"int\"},{\"name\":\"salary\",\"type\":\"double\"},{\"name\":\"years_spent\",\"type\":\"int\"},{\"name\":\"title\",\"type\":\"string\"},{\"name\":\"department\",\"type\":\"string\"}]}");
   ...
   */
  public employee_record(java.lang.CharSequence id, java.lang.CharSequence name, java.lang.Integer age, java.lang.Double salary, java.lang.Integer years_spent, java.lang.CharSequence title, java.lang.CharSequence department) {
    this.id = id;
    this.name = name;
    this.age = age;
    this.salary = salary;
  ...
  public static com.cloudera.sa.examples.employee_record.Builder newBuilder() {
    return new com.cloudera.sa.examples.employee_record.Builder();
  }
  
  /** Creates a new employee_record RecordBuilder by copying an existing Builder */
  public static com.cloudera.sa.examples.employee_record.Builder newBuilder(com.cloudera.sa.examples.employee_record.Builder other) {
    return new com.cloudera.sa.examples.employee_record.Builder(other);
  }
  
  /** Creates a new employee_record RecordBuilder by copying an existing employee_record instance */
  public static com.cloudera.sa.examples.employee_record.Builder newBuilder(com.cloudera.sa.examples.employee_record other) {
    return new com.cloudera.sa.examples.employee_record.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<employee_record>
    ...
    private Builder() {
      super(com.cloudera.sa.examples.employee_record.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.cloudera.sa.examples.employee_record.Builder other) {
      super(other);
    ...
    private Builder(com.cloudera.sa.examples.employee_record other) {
            super(com.cloudera.sa.examples.employee_record.SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'id' field */
    public com.cloudera.sa.examples.employee_record.Builder setId(java.lang.CharSequence value) {
    ...
    public com.cloudera.sa.examples.employee_record.Builder clearId() {
      id = null;
    ...
    /** Sets the value of the 'name' field */
    public com.cloudera.sa.examples.employee_record.Builder setName(java.lang.CharSequence value) {
    ...
    public com.cloudera.sa.examples.employee_record.Builder clearName() {
      name = null;
    ...
    /** Sets the value of the 'age' field */
    public com.cloudera.sa.examples.employee_record.Builder setAge(int value) {
    ...
    public com.cloudera.sa.examples.employee_record.Builder clearAge() {
    ...
    /** Sets the value of the 'salary' field */
    public com.cloudera.sa.examples.employee_record.Builder setSalary(double value) {
    ...
    public com.cloudera.sa.examples.employee_record.Builder clearSalary() {
    ...
    /** Sets the value of the 'years_spent' field */
    public com.cloudera.sa.examples.employee_record.Builder setYearsSpent(int value) {
    ...
    public com.cloudera.sa.examples.employee_record.Builder clearYearsSpent() {
    ...
    /** Sets the value of the 'title' field */
    public com.cloudera.sa.examples.employee_record.Builder setTitle(java.lang.CharSequence value) {
    ...
    public com.cloudera.sa.examples.employee_record.Builder clearTitle() {
      title = null;
    ...
    /** Sets the value of the 'department' field */
    public com.cloudera.sa.examples.employee_record.Builder setDepartment(java.lang.CharSequence value) {
    ...
    public com.cloudera.sa.examples.employee_record.Builder clearDepartment() {
      department = null;
